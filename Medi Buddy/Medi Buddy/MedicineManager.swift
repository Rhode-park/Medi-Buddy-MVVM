...
class MedicineManager {
    ...
    lazy var list = [Medicine(name: "프로비질", maximumDose: 2, currentDose: 2, category: CategoryManager.shared.getCategory(of: .morning)),
                     ...
                     Medicine(name: "명인탄산리튬정150mg", maximumDose: 3, currentDose: 2, category: CategoryManager.shared.getCategory(of: .custom("비염약"))),
